namespace ZADANIE_8
{
    internal class Program
    {
        ...
        static void VvodCoordinat()
        {
            ...
            do
            {
                Console.Write("Введите координаты 1 и 2 положения (например, a1 b3): ");
                string[] coordinat = Console.ReadLine()?.Split(' ');

                vvod_reght = coordinat?.Length == 2 && coordinat[0] != coordinat[1] &&
                             CorrectPosition(coordinat[0]) && CorrectPosition(coordinat[1]);
